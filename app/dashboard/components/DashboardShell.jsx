                ...
                <header className="bg-white border-b border-slate-200 shadow-sm">
                    <div className="max-w-[1920px] mx-auto px-6 py-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                {/* Input/Outputs Toggle */}
                                <div className="flex bg-slate-100 p-1 rounded-lg border border-slate-200">
                                    <button
                                        className="px-3 py-1.5 rounded-md text-sm font-semibold transition-all bg-indigo-600 text-white shadow-lg shadow-indigo-500/25"
                                    >
                                        Inputs
                                    </button>
                                    <button
                                        className="px-3 py-1.5 rounded-md text-sm font-semibold transition-all text-slate-600 hover:text-slate-900 hover:bg-slate-200"
                                    >
                                        Outputs
                                    </button>
                                </div>
